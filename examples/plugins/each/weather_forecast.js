...
// state uses the `each` Plug-In to iterate over a list of WOEID 
...
// `iterator` function is called with the returned data. This 
// data is simply dumped to the console. The `par` parameter is 
// used to set the maximum number of requests made in parallel, 
// in this case 6.
//
// Example Output:
