...
// how to use the `detect` Plug-In. The state machine queries the 
...
// uses the `detect` Plug-In to iterate over a list of WOEID 
...
// `imports` object (Line 29). It wraps the `yahooapis.request` 
