...
// uses the `each` plugin to make a HTTP request to each of the 
...
// transition argument.
//
// The default callback function defined in the `defaults` object of the 
// [SMGF](/documentation/overview/state_machine_generator_function.html) 
// simply loops through the `boxOffice` 
// array, printing its contents.
//
// Example Output:
